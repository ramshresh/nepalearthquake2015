...
<div class="container-fluid">
    ...
    <div class="col-lg-9">
        ...
        <div id="surveyDetailsHeritage" class="row">
            <!--{{{START: col1            -->
            <div class="col-lg-3">
                <!--{{{START: user Contribution        -->
                <div class="row" id="heritageUserContribution">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="active"><a href="#heritageUserContributionTable" role="tab"
                                                      data-toggle="tab">User Contribution</a></li>
                            </ul>
                        </div>
                        <!-- Tab panes + Panel body -->
                        <div class="panel-body tab-content">
                            <div class="tab-pane active" id="heritageUserContributionTable">
                                <div id="heritageUserContributionTable_count"
    ...
    <div class="col-lg-3">
        ...
        <div class="row" id="cartBox">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <!-- Nav tabs -->
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="active"><a href="#chartHeritage" role="tab" data-toggle="tab">Damage Type</a></li>
                        <li><a href="#chart_2" role="tab" data-toggle="tab">Location</a></li>
                    </ul>

                </div>
                <!-- Tab panes + Panel body -->
                <div class="panel-body tab-content">
                    <div class="tab-pane active" id="chartHeritage">
                        <div id="chartContainerPie_Heritage"
                             style="min-width: 310px; height: 400px; max-width: 600px; margin: 0 auto">
                        </div>
                    </div>
                    <div class="tab-pane" id="chart_2">
                        <div id="chartContainerPie_HeritageLocation"
                             style="min-width: 310px; height: 400px; max-width: 600px; margin: 0 auto">
                            Chart based on Location(ward,municipality) boundary (to be implemented)
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body popup-details-external" id="selected_photo">
                <!--{{{START: photo carousel                   -->
                <div id="photoCarousel_heritage" class="carousel slide" data-ride="carousel">
                    <!-- Indicators -->
                    <ol class="carousel-indicators">
                        <!--<li data-target="#photoCarousel_heritage" data-slide-to="0" class="active"></li>
                        <li data-target="#photoCarousel_heritage" data-slide-to="1"></li>
                        <li data-target="#photoCarousel_heritage" data-slide-to="2"></li>
                        <li data-target="#photoCarousel_heritage" data-slide-to="3"></li>-->
                    </ol>

                    <!-- Wrapper for slides -->
                    <div class="carousel-inner carousel-heritage-photo" role="listbox">
                        Select a Marker
                    ...
                    <a class="left carousel-control" href="#photoCarousel_heritage" role="button" data-slide="prev">
                        <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
                        <span class="sr-only">Previous</span>
                    </a>
                    <a class="right carousel-control" href="#photoCarousel_heritage" role="button" data-slide="next">
